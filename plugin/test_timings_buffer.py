...
class TimingsBufferTests(unittest.TestCase):
    ...
    def test_extract_llamacpp_usage_timings(self) -> None:
        ...
        self.assertEqual(out["predicted_per_second"], 30.0)

    def test_extract_uses_response_timings_when_hook_usage_stripped(self) -> None:
        response = {
            "timings": {
                "prompt_ms": 700.0,
                "predicted_ms": 250.0,
        ...
        stripped_usage = {"prompt_tokens": 40, "completion_tokens": 8}
    ...
    def test_extract_from_system_fingerprint(self) -> None:
        ...
        self.assertEqual(out["prompt_ms"], 900.0)
        self.assertEqual(out["predicted_ms"], 400.0)
        self.assertEqual(out["prompt_n"], 80)
        self.assertEqual(out["predicted_n"], 12)
        self.assertEqual(out["cache_n"], 10)
